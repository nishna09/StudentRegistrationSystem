...
namespace RepositoryLibrary.Repository
{
    public class SQLQueries
    {
        ...
        public const string GetStudentQuery = @"SELECT st.StudentId, NationalID, FirstName, LastName, GuardianName, DateOfBirth, StatusId, ContactNumber,s.SubjectId, SubjectName, Grade, street, City, Country
                                                from Students st
